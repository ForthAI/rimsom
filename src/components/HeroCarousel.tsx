...
const slides = [
  {
    ...
    description:
      "Rimsom Global operates where trust, timing, and access shape outcomes, bridging markets, investors, and partners to create lasting impact across international markets.",
