        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleLogin}>
            <input
              ...
              required
              className="w-full px-4 py-3.5 bg-white/10 border border-white/20 text-[14px] text-white font-sans outline-none focus:border-brand-gold transition-colors duration-200 placeholder:text-white/30 mb-4"
            />
            <button
              type="submit"
